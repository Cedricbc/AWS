            ...
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="display:block">
                        ...
                        <a href="{{ route('admin.movie.add')}}" role="button" class="btn btn-primary float-sm-right" >Add Patients</a>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                    ...
                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                      ...
                      @foreach($patients as $patient)
                        <tr role="row" class="odd">
                          <td class="sorting_1">{{ $patient->movie_name }}</td>
                          <td>{{ $patient->movie_description }}</td>
                          <td>{{ $patient->created_at }}</td>
                    
                          <td>
                            <div class="row">
                              <div class="col-md-6"><a href="#"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></div>
                              <div class="col-md-6"><a href="{{ route('admin.patient.delete',$patient->id) }}"><i class="fa fa-times" aria-hidden="true"></i></a></div>
                            </div>
                          </td>
                        </tr>
                        @endforeach
